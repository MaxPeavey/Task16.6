...
public class Tests
{
    public class CalculatorTests
    {
        ...
        [Test]
        public void Additional_MustReturnCorrectType()
        {
        ...
        [Test]
        public void Subtraction_MustReturnCorrectType()
        {
        ...
        [Test]
        public void Multiplication_MustReturnCorrectType()
        {
            Assert.That(_calculator.Miltiplication(7,7),  Is.EqualTo(49));
        }
        ...
        [Test]
        public void Division_MustReturnCorrectType()
        {
